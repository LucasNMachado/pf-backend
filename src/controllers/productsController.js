...
export const getDataProductById = async (req, res) => {
    try {
        ...
        return handleResponse(res, message, !!product);
    } catch (error) {
...
export const createDataProduct = async (req, res) => {
    try {
        ...
        return handleResponse(res, message, !!newProduct);
    } catch (error) {
...
export const updateDataProduct = async (req, res) => {
    try {
        ...
        return handleResponse(res, message, !!productUpdate);
    } catch (error) {
...
export const deleteDataProduct = async (req, res) => {
    try {
        ...
        return handleResponse(res, message, !!productDelete);
    } catch (error) {
